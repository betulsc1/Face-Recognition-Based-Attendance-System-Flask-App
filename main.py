...
def tick():
    ...
    time.time(text=time_string)
    time.time(200,tick)
    
def contact():
    mess._show(title='Contact Us', message="Please contact us on : 'betulsenacoskun0@gmail.com'")
...
def change_pass():
    ...
    lb14 = tk.Label(master,text='    Enter Old Password',bg='white',font=('times', 12, ' bold '))
